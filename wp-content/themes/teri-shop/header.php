                ...
                <div class="header-inner">
                    ...
                    <a class="navbar-brand" href="<?php echo home_url(); ?>">
                        <?php if (is_front_page() || is_home()): ?>
                            ...
                            <picture>
                                <img class="black-logo" src="<?php echo get_template_directory_uri() ?>/assets/images/black-logo.svg" alt="logo"
                                    width="166" height="37">
                            </picture>
                        <?php else: ?>
                            <picture>
                                <img class="blacklogo" src="<?php echo get_template_directory_uri() ?>/assets/images/black-logo.svg" alt="logo"
                                    width="166" height="37">
                            </picture>
                        <?php endif; ?>
                    </a>
                    ...
                    <div class="header-right">
                        ...
                        <?php if (!is_user_logged_in()) { ?>
                            <div class="h-loginup">
                                <button class="h-btn signup-btn active" data-toggle="modal" id="open-signin"
                                    data-target="#signup">
                                    <span class="login-text">Login</span>
                                </button>
                                <button class="h-btn signup-btn active" data-toggle="modal" id="open-signup"
